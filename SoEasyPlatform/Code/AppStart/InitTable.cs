        ...
        private  void InitProject(SqlSugarClient db)
        {
            ...
            if (db.Queryable<Project>().Count() == 0)
            {
                ...
                db.Insertable(new Project()
                {
                    ...
                    FileModel = "[{ \"name\":\"命名空间\",\"nuget\":[{ \"name\":\"SqlSugarCore\",\"version\":\"5.0.3.4\" }]},{\"name\":\"Startup\", \"name_space\":\"命名空间\" },{\"name\":\"Program\", \"name_space\":\"命名空间\" },{\"name\":\"appsettings\", \"name_space\":\"命名空间\"},{\"name\":\"Properties\\launchSettings\", \"name_space\":\"命名空间\"}".Replace("命名空间",$"{_defaultNamespace}.Api"),
